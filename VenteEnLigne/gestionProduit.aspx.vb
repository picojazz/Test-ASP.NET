Public Class gestionProduit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            Label1.Text &= "<tr><th>code produit</th><th>photo</th><th>designation</th><th>prix unitaire</th><th>quantite en stock</th><th>voir</th><th>editer</th><th>supprimer</th></tr>"
            dr = afficherProduit()
            If dr.HasRows Then
                While dr.Read
                    Label1.Text &= "<tr><td>" & dr(0) & "</td><td><img src='" & dr(4) & "' width ='50px' height='50px'  ></td><td>" & dr(1) & "</td><td>" & dr(2) & "</td><td>" & dr(3) & "</td><td><a class='btn btn-primary voir' data-toggle='modal' href='#modal-id'>voir</a></td><td><a href='modifProduit.aspx?id=" & dr(0) & "' class='btn btn-success'>editer</a></td><td><a href='suppProduit.aspx?id=" & dr(0) & "' class='supp btn btn-danger' >supprimer</a></td></tr>"
